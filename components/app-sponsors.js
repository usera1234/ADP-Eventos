...
import './sponsors-rows/app-sponsors-row-1.1.js';
...
class AppSponsors extends HTMLElement {
    constructor() {
        ...
        this.innerHTML = `
            ...
            <app-sponsors-row-11></app-sponsors-row-11>   <!-- file:///C:/Proyectos/ADP-Eventos/components/sponsors-row/app-sponsors-row-1.1.js -->
            ...
            <app-sponsors-row-7></app-sponsors-row-7>   <!-- file:///C:/Proyectos/ADP-Eventos/components/sponsors-row/app-sponsors-row-7.js -->

            <app-sponsors-row-8></app-sponsors-row-8>   <!-- file:///C:/Proyectos/ADP-Eventos/components/sponsors-row/app-sponsors-row-8.js -->
            </div>
        `;    
    }
}
